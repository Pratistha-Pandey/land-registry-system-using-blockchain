...
contract LandRegistration {
    ...
    function VerifySeller(address add) public onlylandinspector {
        IsSellerVerify[add] = true;
    }

    //function of reject seller

    function RejectSeller(address add) public onlylandinspector {
    ...
    function VerifyBuyer(address addr) public onlylandinspector {
        IsBuyerVerify[addr] = true;
    }

    //function of reject buyer

    function RejectBuyer(address addr) public onlylandinspector {
    ...
    function RegisterLand(
        ...
        LandDetails[_LandID] = RegistrationLand(
            Area,
            City,
            State,
            LandPriceInWei,
    ...
    function RegisterLandInspector(
        ...
        LandInspectorDetails[LandInspector] = LandInspectorDetail(
            ID,
            NAME,
            AGE,
            Designation
    ...
    function BuyLand(uint _LandID) public payable {
        ...
        require(
            msg.value >= LandDetails[_LandID].LandPriceInWei,
            "please pay me ether"
        );
